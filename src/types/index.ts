// Assets soportados por AgentWallet
export const DEFAULT_ASSETS = ["XRD", "HUSDC", "HUSDT", "HWBTC", "HETH"] as const;
...
export interface AgentWalletConfig {
  ...
  // Clave privada del agente para firmar transacciones
  privateKey?: string; // now from keystore
  network: NetworkType;
